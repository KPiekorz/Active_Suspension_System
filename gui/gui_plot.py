...
class GUI(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # Set plot paramaters
        plot_control = MplCanvas(self, width=5, height=4, dpi=100)
        plot_control.axes.plot([0, 1, 2, 3, 4], [10, 1, 20, 3, 40])

        plot_model = MplCanvas(self, width=5, height=4, dpi=100)
        plot_model.axes.plot([0, 1, 2, 3, 4], [10, 1, 20, 3, 40])
        ...
        box_layout.addWidget(plot_control)
        box_layout.addWidget(toolbar_model)
        box_layout.addWidget(plot_model)
